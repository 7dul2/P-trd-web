...
var component_names = ['input','button','message','picker_wheel',"select"];
...
function ru_get_element_height_with_margin(element) {
    // 获取元素本身的高度
    ...
    // 计算带外边距的总高度
    const total_height = element_height + margin_top + margin_bottom;
